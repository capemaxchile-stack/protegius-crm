...
function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-medium text-xs shadow-md transition disabled:opacity-50"
    >
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-white tracking-tight">Nueva Cuenta / Empresa</h1>
      ...
      <form action={formAction} className="space-y-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
          <div className="flex items-center gap-2 pb-3 border-b border-slate-800">
            ...
            <h2 className="text-sm font-semibold text-white">1. Identificación de la Empresa</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="razonSocial">
                Razón Social / Nombre de Fantasía <span className="text-rose-400">*</span>
              </label>
              <input
                id="razonSocial"
                name="razonSocial"
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            ...
            <span className="text-[11px] text-slate-500">Puedes agregarlo ahora o después</span>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="contactoNombre">
                Nombre del Contacto
              </label>
              <input
                id="contactoNombre"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="contactoCargo">
                Cargo
              </label>
              <input
                id="contactoCargo"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="contactoEmail">
                Correo Electrónico
              </label>
              <input
                id="contactoEmail"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="contactoTelefono">
                Teléfono / WhatsApp
              </label>
              <input
                id="contactoTelefono"
