  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-medium text-xs shadow-sm transition"
      >
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl relative animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-slate-800">
              <h3 className="font-semibold text-white text-sm">Gestionar Contactos de la Empresa</h3>
              <button
            ...
            {/* Tabs */}
            <div className="flex border-b border-slate-800 mt-4 mb-4">
              <button
                type="button"
                onClick={() => setTab("nuevo")}
                className={`flex-1 py-2 text-xs font-medium border-b-2 transition flex items-center justify-center gap-1.5 ${
                  tab === "nuevo"
            ...
            {tab === "nuevo" && (
              <form action={formActionNuevo} className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="nombre">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="cargo">
                      Cargo en la Empresa
                    </label>
                    <input
                      id="cargo"
                  ...
                  <div>
                    <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="telefono">
                      Teléfono / Móvil
                    </label>
                    <input
                      id="telefono"
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="nota">
                ...
                <div className="flex items-center gap-2 pt-1">
                  ...
                  />
                  <label htmlFor="esPrincipal" className="text-xs text-slate-300">
              ...
              <form action={formActionExistente} className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="personaId">
                    Seleccionar Persona del Sistema <span className="text-rose-400">*</span>
                  </label>
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="cargoExistente">
                ...
                <div className="flex items-center gap-2 pt-1">
                  <input
                    ...
                    className="w-4 h-4 rounded border-slate-800 bg-slate-950 text-blue-600 focus:ring-blue-500"
                  />
                  <label htmlFor="esPrincipalExistente" className="text-xs text-slate-300">
                    Marcar como contacto principal de esta empresa
                  </label>
                </div>
