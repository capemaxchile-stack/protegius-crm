      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">Cuentas y Empresas</h1>
          </div>
              ...
              {cuentas.length === 0 ? (
                <tr>
                  <td colSpan={7} className="py-12 text-center text-slate-400">
                    ...
                    <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">No se encontraron cuentas</p>
                  ...
                  return (
                    <tr key={c.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/30 transition group">
                      <td className="py-4 px-4 font-bold text-slate-900 dark:text-white">
                        ...
                        {c.rubro && <p className="text-[11px] text-slate-500 dark:text-slate-400 font-normal">{c.rubro}</p>}
                      </td>
                      ...
                      <td className="py-4 px-4">
                        {contactoPrincipal ? (
                          <div>
                            <p className="font-semibold text-slate-800 dark:text-slate-200">{contactoPrincipal.nombre}</p>
                            <p className="text-[10px] text-slate-500 dark:text-slate-400">{contactoPrincipal.cargo || contactoPrincipal.email || "—"}</p>
                          </div>
                        ) : (
                      ...
                      <td className="py-4 px-4 text-slate-500 dark:text-slate-400">
                        <span className="inline-flex items-center gap-1">
                          ...
                          <span className="font-semibold text-slate-700 dark:text-slate-300">{c._count.oportunidades}</span>
                        </span>
                      </td>
