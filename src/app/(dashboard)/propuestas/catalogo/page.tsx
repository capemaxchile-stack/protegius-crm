        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-white tracking-tight">Catálogo Maestro de Precios en UF</h1>
            </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl space-y-6">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-semibold text-white">Planes y Tarifas Base (en UF)</h2>
              </div>
              <span className="text-[11px] text-slate-400">Valores mensuales</span>
            </div>
                    ...
                    {grupo.planes.map((plan) => (
                      ...
                      >
                        <div>
                          ...
                          {plan.detalle && (
                            <p className="text-slate-400 text-[11px] mt-0.5">{plan.detalle}</p>
                          )}
                        </div>
                          ...
                          >
                            <button
                              ...
                              className={`p-1.5 rounded-lg border transition ${
                                plan.activo
                                  ? "bg-slate-900 border-slate-700 text-emerald-400 hover:text-rose-400"
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl space-y-4">
            ...
            <form action={crearPlanAction} className="space-y-3 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  <label className="block text-slate-300 mb-1">Grupo de Plan</label>
                  <select
                    name="grupoId"
                    required
                ...
                <div className="sm:col-span-2">
                  <label className="block text-slate-300 mb-1">Nombre del Plan</label>
                  <input
                    name="nombre"
                    type="text"
                    required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-300 mb-1">Detalle / Capacidad</label>
                  <input
                    name="detalle"
                    type="text"
                ...
                <div>
                  <label className="block text-slate-300 mb-1">Valor Empresa (UF/mes)</label>
                  <input
                    name="valorEmpresaUF"
                    type="number"
                    step="0.1"
        ...
        <div className="space-y-6">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-semibold text-white">Servicios de Alcance</h2>
              </div>
            </div>
            ...
            <div className="space-y-2.5">
              {servicios.map((s) => (
                ...
                >
                  ...
                  {s.descripcion && (
                    <p className="text-slate-400 text-[11px] leading-relaxed">{s.descripcion}</p>
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl space-y-4">
            ...
            <form action={crearServicioAction} className="space-y-3 text-xs">
              <div>
                <label className="block text-slate-300 mb-1">Nombre del Servicio</label>
                <input
                  name="nombre"
                  type="text"
                  required
              ...
              <div>
                <label className="block text-slate-300 mb-1">Descripción / Alcance</label>
                <textarea
                  name="descripcion"
                  rows={2}
