      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-white tracking-tight">Oportunidades Comerciales</h1>
          </div>
              ...
              {oportunidades.length === 0 ? (
                <tr>
                  <td colSpan={7} className="py-12 text-center text-slate-500">
                    ...
                    <p className="text-sm font-medium text-slate-300">No se encontraron oportunidades</p>
                ...
                oportunidades.map((op) => {
                  ...
                  return (
                    <tr key={op.id} className="hover:bg-slate-800/30 transition group">
                      ...
                      <td className="py-4 px-4 text-slate-300">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[11px] font-medium">{op.probabilidad || 10}%</span>
                        </div>
                      </td>
