  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-white tracking-tight">Nueva Oportunidad Comercial</h1>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
        <form action={handleCrear} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="cuentaId">
                Empresa / Cuenta <span className="text-rose-400">*</span>
              </label>
              <select
                id="cuentaId"
                name="cuentaId"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="valorEstimado">
                Valor Estimado (UF)
              </label>
              <input
                id="valorEstimado"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="probabilidad">
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="fechaCierreEstimada">
