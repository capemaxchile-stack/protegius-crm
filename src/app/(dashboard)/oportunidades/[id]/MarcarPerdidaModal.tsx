...
function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="px-5 py-2 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-semibold text-xs shadow-md transition disabled:opacity-50"
    >
  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/20 font-medium text-xs transition"
      >
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-md w-full p-6 shadow-2xl relative animate-in fade-in zoom-in-95 duration-150">
            <div className="flex items-center justify-between pb-4 border-b border-slate-800">
              <div className="flex items-center gap-2 text-rose-400">
                ...
                <h3 className="font-semibold text-white text-sm">Marcar Oportunidad como Perdida</h3>
              </div>
              <button
            ...
            <form action={formAction} className="space-y-4 mt-4">
              <div>
                <label className="block text-xs font-medium text-slate-300 mb-1" htmlFor="motivoPerdida">
                  Motivo de Pérdida <span className="text-rose-400">*</span>
                </label>
                <textarea
                  id="motivoPerdida"
                  name="motivoPerdida"
