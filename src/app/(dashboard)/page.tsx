...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome banner - High contrast gradient in both light and dark */}
      <div className="bg-gradient-to-r from-slate-900 via-blue-950 to-indigo-950 border border-slate-800/80 rounded-2xl p-6 shadow-xl relative overflow-hidden text-white">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-md bg-blue-500/20 border border-blue-400/30 text-blue-300 text-xs font-semibold mb-2">
            ...
            <p className="text-slate-300 text-sm mt-1">
              Perfil: <span className="text-white font-bold">{USER_ROLE_LABELS[user.role]}</span> · Control comercial y gestión de clientes
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs border border-slate-700 transition duration-150"
            >
      ...
      {/* Metrics Cards - Light & Dark High Contrast */}
