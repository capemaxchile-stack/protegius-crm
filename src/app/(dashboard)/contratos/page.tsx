      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-white tracking-tight">Contratos & Formalización</h1>
          </div>
              ...
              {contratos.length === 0 ? (
                <tr>
                  <td colSpan={8} className="py-12 text-center text-slate-500">
                    ...
                    <p className="text-sm font-medium text-slate-300">No se encontraron contratos</p>
                  ...
                  return (
                    <tr key={c.id} className="hover:bg-slate-800/30 transition group">
                      ...
                      <td className="py-4 px-4 font-semibold text-white">
                        <Link href={`/contratos/${c.id}`} className="hover:text-blue-400">
                          {c.nombre}
                        </Link>
                      </td>
                      ...
                      <td className="py-4 px-4 text-slate-300">
                        {c.firmantes.length > 0 ? (
                          ...
                          <span className="text-slate-500 italic">Sin firmantes</span>
                        )}
                      </td>
