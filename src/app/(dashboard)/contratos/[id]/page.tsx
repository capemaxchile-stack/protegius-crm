...
export default async function ContratoDetallePage({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Empresa: <strong className="text-slate-200">{contrato.cuenta.razonSocial}</strong>
            </p>
          </div>
        </div>
      ...
      {esFirmado && (
        <div className="p-4 bg-emerald-950/40 border border-emerald-500/30 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-in fade-in duration-200">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-xl bg-emerald-500/20 text-emerald-400 shrink-0">
              <Sparkles className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-xs font-bold text-white">Contrato Firmado y Vigente</h3>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
          <div>
            <span className="text-slate-500 block">Objeto / Nombre</span>
            <span className="font-bold text-white text-sm">{contrato.nombre}</span>
          </div>

          <div>
            <span className="text-slate-500 block">Tipo de Contrato</span>
          ...
          <div>
            <span className="text-slate-500 block">Valor Económico</span>
            <span className="font-bold text-emerald-400 text-sm">{formatearUF(contrato.valor)}</span>
          </div>

          <div>
            <span className="text-slate-500 block">Fecha de Firma</span>
          ...
          <div>
            <span className="text-slate-500 block">Propuesta Origen</span>
            {contrato.propuesta ? (
              <Link
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-white">Firmantes Legales y Contrapartes</h2>
          </div>
